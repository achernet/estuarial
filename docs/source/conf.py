# -*- coding: utf-8 -*-
#
# feldman documentation build configuration file, created by
...
latex_documents = [
  ('index', 'feldman.tex', u'feldman Documentation',
...
man_pages = [
    ('index', 'feldman', u'feldman Documentation',
...
texinfo_documents = [
  ('index', 'feldman', u'feldman Documentation',
   u'Continuum Analytics', 'feldman', 'Python API for QA Direct.',
   'Miscellaneous'),
]
